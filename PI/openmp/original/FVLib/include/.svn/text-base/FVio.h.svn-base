...
public:
    ...
    void put(FVVect <FVPoint1D<double> >&, const double time=0., const string &name="noname");        
    ...
    size_t get(FVVect <double> &,  double &, string &);
          // with FVPOINT2D    
    size_t get(FVVect <FVPoint1D<double> > &u)
         {return(FVio::get(u,_time,_name));}
    size_t get(FVVect <FVPoint1D<double> >&u, double &time)
         {return(FVio::get(u,time,_name));}  
    size_t get(FVVect <FVPoint1D<double> >&, double &, string &);   
    // two vectors
