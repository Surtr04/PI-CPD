...
// constructor
    ...
    FVPoint4D(T_ a) { x = a; y = a; z = a; t = a;}    
    FVPoint4D(T_ a, T_ b, T_ c,T_  d) { x = a; y = b; z = c; t = d;}
// Copy constructor
...
//}
inline double Norm(const FVPoint4D<double> &u,const FVPoint4D<double> &v)
{
   return u.x*v.x+u.y*v.y+u.z*v.z+u.t*v.t;
}
