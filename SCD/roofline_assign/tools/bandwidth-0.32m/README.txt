...
Version 0.30 adds cache detection for Intel 64-bit CPUs.
Version 0.29 improved graph granularity with more
	128-byte tests and removes ARM support.
Version 0.28 added a proper test of CPU features e.g. SSE 4.1.
Version 0.27 added finer-granularity 128-byte tests.
Version 0.26 fixed an issue with AMD processors.
Version 0.25 maked network bandwidth bidirectional.
Version 0.24 added network bandwidth testing.
